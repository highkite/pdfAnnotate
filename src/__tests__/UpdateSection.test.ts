import { UpdateSection } from '../document-history';

test('extractSubSectionHeader', () => {
        let data = new Int8Array([48, 32, 49]) // 0 1
        let us = new UpdateSection(data)
...
test('extractSubSectionHeader', () => {
        let data = new Int8Array([48, 32, 49, 13]) // 0 1\n
        let us = new UpdateSection(data)
...
test('extractSubSectionHeader', () => {
        let data = new Int8Array([50, 53, 48, 32, 56, 57, 32]) // "250 89 "
        let us = new UpdateSection(data)
...
test('extractReferences', () => {
         ...
         * 0000001352 00000 n
         * */
        let data = new Int8Array([48, 48, 48, 48, 48, 48, 49, 51, 50, 49, 32, 48, 48, 48, 48, 48, 32, 110, 32, 48, 48, 48, 48, 48, 48, 49, 51, 53, 50, 32, 48, 48, 48, 48, 48, 32, 110])
        let us = new UpdateSection(data)
...
test('extractReferences', () => {
         ...
         * 0000001352 00000 n
         * */
        let data = new Int8Array([48, 48, 48, 48, 48, 48, 49, 51, 50, 49, 32, 48, 48, 48, 48, 48, 32, 110, 10, 48, 48, 48, 48, 48, 48, 49, 51, 53, 50, 32, 48, 48, 48, 48, 48, 32, 110])
        let us = new UpdateSection(data)
...
test('extractTrailer', () => {
         ...
         * %%EOF
         * */
        let data = new Int8Array([116, 114, 97, 105, 108, 101, 114, 10, 60, 60, 47, 83, 105, 122, 101, 32, 57, 32, 47, 82, 111, 111, 116, 32, 49, 32, 48, 32, 82, 32, 47, 80, 114, 101, 118, 32, 49, 49, 53, 48, 32, 62, 62, 10, 115, 116, 97, 114, 116, 120, 114, 101, 102, 10, 49, 54, 52, 56, 10, 37, 37, 69, 79, 70])
        let us = new UpdateSection(data)
