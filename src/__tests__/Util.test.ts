...
test('extractArrayNested', () => {
    let data = new Int8Array([91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 91, 49, 32, 50, 32, 51, 32, 93, 93])
    expect(Util.extractArray(data, 0)).toEqual([[1, 2, 3], [1, 2, 3]])

    data = new Int8Array([91, 91, 54, 32, 48, 32, 82, 32, 56, 32, 48, 32, 82, 32, 93, 32, 93]) // reference pointer array
    expect(Util.extractArray(data, 0)[0][0].obj).toEqual(6)
    expect(Util.extractArray(data, 0)[0][0].generation).toEqual(0)
    expect(Util.extractArray(data, 0)[0][1].obj).toEqual(8)
    expect(Util.extractArray(data, 0)[0][1].generation).toEqual(0)
})
...
test('extractField-WITHOUTSPACES', () => {
    ...
    //endobj
    let data = new Int8Array([50, 32, 48, 32, 111, 98, 106, 10, 60, 60, 47, 84, 121, 112, 101, 47, 80, 97, 103, 101, 115, 47, 67, 111, 117, 110, 116, 32, 51, 47, 75, 105, 100, 115, 91, 32, 51, 32, 48, 32, 82, 32, 49, 53, 32, 48, 32, 82, 32, 49, 55, 32, 48, 32, 82, 93, 32, 62, 62, 10, 101, 110, 100, 111, 98, 106, 10])
...
test('extractNumbersArray', () => {
    ...
    data = new Int8Array([91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 93, 32])
    expect(Util.extractNumbersArray(data, 0)[0]).toEqual([1, 2, 3])

    data = new Int8Array([91, 91, 53, 51, 54, 46, 50, 53, 49, 53, 51, 54, 32, 51, 56, 55, 46, 57, 55, 53, 52, 53, 54, 32, 93, 32, 93])
    expect(Util.extractNumbersArray(data, 0)[0]).toEqual([536.251536, 387.975456])

    data = new Int8Array([91, 91, 53, 51, 54, 46, 50, 53, 49, 53, 51, 54, 32, 51, 56, 55, 46, 57, 55, 53, 52, 53, 54, 32, 93, 32, 93, 10])
    expect(Util.extractNumbersArray(data, 0)[0]).toEqual([536.251536, 387.975456])

    data = new Int8Array([32, 91, 91, 51, 56, 55, 46, 57, 55, 53, 52, 53, 54, 32, 93, 32, 93, 32])
    expect(Util.extractNumbersArray(data, 0)).toEqual([[[387.975456]]])
})

test('extractNumbersArrayNested', () => {
    let data = new Int8Array([91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 93])
    expect(Util.extractNumbersArray(data, 0)).toEqual([[1, 2, 3]])

    data = new Int8Array([91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 91, 49, 32, 50, 32, 51, 32, 93, 93])
    expect(Util.extractNumbersArray(data, 0)).toEqual([[1, 2, 3], [1, 2, 3]])

    data = new Int8Array([91, 91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 93, 32, 93])
    expect(Util.extractNumbersArray(data, 0)).toEqual([[[1, 2, 3]]])

    data = new Int8Array([91, 91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 91, 49, 32, 50, 32, 51, 32, 93, 32, 93, 32, 93])
    expect(Util.extractNumbersArray(data, 0)).toEqual([[[1, 2, 3], [1, 2, 3]]])

    data = new Int8Array([91, 91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 91, 32, 91, 32, 49, 32, 50, 32, 51, 32, 93, 32, 93, 32, 93, 32, 93])
    expect(Util.extractNumbersArray(data, 0)[0][0]).toEqual([1, 2, 3])
    expect(Util.extractNumbersArray(data, 0)[0][1]).toEqual([[1, 2, 3]])
})
...
test('extractArraySequence', () => {
    ...
    data = new Int8Array([32, 91, 50, 32, 51, 32, 82, 32, 52, 48, 32, 53, 32, 82, 93])
    solution = new Int8Array([50, 32, 51, 32, 82, 32, 52, 48, 32, 53, 32, 82])
    expect(Util.extractArraySequence(data, 1)).toEqual(solution)
})

test('extractArraySequenceNested', () => {
    let data = new Int8Array([91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 93])
    let solution = new Int8Array([49, 32, 50, 32, 51, 32])
    expect(Util.extractArraySequence(data, 0)).toEqual([solution])

    data = new Int8Array([91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 91, 49, 32, 50, 32, 51, 32, 93, 93])
    expect(Util.extractArraySequence(data, 0)).toEqual([solution, solution])
    ...
    data = new Int8Array([91, 91, 91, 49, 32, 50, 32, 51, 32, 93, 32, 91, 32, 91, 32, 49, 32, 50, 32, 51, 32, 93, 32, 93, 32, 93, 32, 93])
    expect(Util.extractArraySequence(data, 0)[0][0]).toEqual(solution)
    expect(Util.extractArraySequence(data, 0)[0][1]).toEqual([new Int8Array([32, 49, 32, 50, 32, 51, 32])])
})
