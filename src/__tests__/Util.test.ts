...
test('extractArray', () => {
        ...
        expect(Util.extractArray(data, 0)[0]).toEqual([1, 2, 3])
...
test('extractField', () => {
        ...
        expect(Util.extractField(data, Util.RECT)[0]).toEqual([77.7777777778, 83.7931904161, 83.7777777778, 89.7856242119])
        ...
        expect(Util.extractField(data, Util.C)[0]).toEqual([1, 1, 0])
        expect(Util.extractField(data, Util.CA)).toEqual(1)
        expect(Util.extractField(data, Util.BORDER)[0]).toEqual([0, 0, 1])
        ...
        //expect(Util.extractField(data, Util.INKLIST)).toEqual('abc')
})
...
test('extractNumbersArray', () => {
        ...
        expect(Util.extractNumbersArray(data, 0)[0]).toEqual([77.7777777778, 83.7931904161, 83.7777777778, 89.7856242119])
})
...
test('extractArraySequence', () => {
        ...
        expect(Util.extractArraySequence(data, 0)[0]).toEqual(solution)
        expect(Util.extractArraySequence(data, 5)[0]).toEqual(solution)
        expect(Util.extractArraySequence(data, 13)[0]).toEqual(solution)

        data = new Int8Array([91, 91, 49, 44, 50, 44, 51, 93, 44, 91, 49, 44, 50, 44, 51, 93, 93, 32])
        let _solution = [[49, 44, 50, 44, 51], [49, 44, 50, 44, 51], [91, 49, 44, 50, 44, 51, 93, 44, 91, 49, 44, 50, 44, 51, 93]]

        let res = Util.extractArraySequence(data, 0)
        expect(res[0]).toEqual(new Int8Array(_solution[0]))
        expect(res[1]).toEqual(new Int8Array(_solution[1]))
        expect(res[2]).toEqual(new Int8Array(_solution[2]))
})
